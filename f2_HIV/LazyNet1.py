...
dat1 = np.genfromtxt('./trainset.txt', delimiter=',', dtype=float)
dat1 = np.vstack(dat1)
dat1 = dat1[:, 2:]
dat1 = np.log(dat1+1)
...
modelname = str(runcount)+'_LazyNet1_trainset_'+str(width)+'X'+str(depth)+'Xe'+str(enumber)+'bsize'+str(bsize)+'@'+str(LRN)+'dk'+str(dcay)+'_log_cuda'+str(gnum)+".pth"
